    ...
    <div class="containerr">
        ...
        <div class="col-md-9 text-justify">
            ...
            <section class="welcome">
                <h1>Selamat Datang di Delear Honda Mas Agus</h1>
                <p>Kami adalah dealer resmi motor Honda terpercaya di Bali.</p>
                <a href="aboutUs.php" class="btn btn-info">Tentang Kami</a>
            </section>
        </div>
